export {
    ...
    type CheckedSettingsArtifacts,
    type GeneratedSettingsArtifacts,
    type RenderedSettingsArtifacts,
    type SettingsArtifactTargets,
} from "./artifacts.ts";
export {
...
export {
    discoverSettingsProjects,
    PACKAGE_MANIFEST_KEY,
    type SettingsArtifactProject,
} from "./projects.ts";
export {
